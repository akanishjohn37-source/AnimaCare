...
export default function ShelterDashboard() {
  ...
  const [intakeForm, setIntakeForm] = useState({
    name: '', species: 'Dog', breed: '', medical_triage_status: 'Injured', media_url: '',
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           ...
                           <div>
                              ...
                              <input type="text" value={intakeForm.breed} onChange={e => setIntakeForm({...intakeForm, breed: e.target.value})} className="w-full bg-neutral-800 border border-neutral-700 rounded-xl p-3 text-white outline-none focus:border-emerald-500" placeholder="e.g. Lab" />
                           </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                           <div>
