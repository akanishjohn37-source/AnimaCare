    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('citizen', 'Citizen / Pet Owner'), ('veterinarian', 'Veterinary Doctor'), ('shelter_admin', 'Shelter Administrator'), ('civic_authority', 'Civic Authority'), ('admin', 'System Administrator')], default='citizen', max_length=30)),
